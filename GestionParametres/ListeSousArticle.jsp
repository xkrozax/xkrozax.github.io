...
<html>
  <head>
    ...
    { 
        ...
        $("#prixVente").val($('#prixVente2<%=i%>').val());
  ...
  <body>  
     ...
     <tr> 
     <th> <font color="#000000"> <h3>Produit / SousArticle </h3> </font></th>
     <th> <font color="#000000"> <h3>Réference </h3> </font></th>
     <th> <font color="#000000"> <h3>Prix Achat </h3> </font></th>
     <th> <font color="#000000"> <h3>Prix Vente </h3> </font></th>  
     <th>  </th> 
     <th> <font color="#000000"> <h3>Stock Initial </h3> </font></th>   
     <th> <font color="#000000"> <h3>Quantité Entrée </h3> </font></th> 
     <th> <font color="#000000"> <h3>Quantité Sortie </h3> </font></th> 
     <th> <font color="#000000"> <h3>Quantité du Stock </h3> </font></th> 
     <th>  </th>   
     </tr>
     ...
     <tr id="ligne<%=i%>">   
	 <td><input type="text" name="sousArticle2<%=i%>"  id="sousArticle2<%=i%>" value="<%=tabSousArticle[i].getSousArticle()%>"  size="30"/>  </td>										 			     
     <td><input type="text" name="reference2<%=i%>"  id="reference2<%=i%>" value="<%=tabSousArticle[i].getReference()%>"  size="24"/>  </td>  
     <td><input type="number" name="prixAchat2<%=i%>"  id="prixAchat2<%=i%>" value="<%=tabSousArticle[i].getPrixAchat()%>"  class="number_input"/>  </td>
     <td><input type="number" name="prixVente2<%=i%>"  id="prixVente2<%=i%>" value="<%=tabSousArticle[i].getPrixVente()%>"  class="number_input"/>  </td>
