  ...
  <head>
    ...
    $("#chargement").show();  
        ...
        {    
            ...
            url: "rechercherReductionInscription.do", 
               ...
               Enregistrer: function() {
                     ...
                     $.ajax( 
                           {    
                            type: "POST", 
                            enctype:"multipart/form-data",
                            url: "ajouterReductionInscription.do", 
...
<!-- Free CSS Templates @ www.TemplateMo.com -->
    ...
    <ul class="niveau1">   
            ...
            <li><a href="GestionParametres/ParametresReductionInscription.jsp"> <input type="button" class="btn btn-primary" value= " Paramètres Réduction d'inscription " /> </a>  </li>               	                                            	                                         	                                            	                                                   	                                            	                                         	                                            	                             
    ...
    <div id="templatemo_content">
            ...
            <table>
	        <tr>
		        <td><input type="button" id="rechercherArticle"  class="btn btn-default"  value="  Liste des Réductions des inscriptions  " size="35"/>  </td>
		        <td><input type="button" id="ajouterArticle"  class="btn btn-default"  value="  Ajouter Réduction d'Inscription  " size="35"/>  </td>
	        </tr>
	        </table>	        
	        </form>		        
	    	...
	    	<div id ="dialogAjouterArticle"  title = "Ajouter Réduction d'inscription" >                    	            
