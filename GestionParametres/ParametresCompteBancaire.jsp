	...
	$(function(){
     ...
     $("#chargement").show();  
        ...
        {    
            ...
            url: "rechercherCompteBancaire.do", 
...
<!-- Free CSS Templates @ www.TemplateMo.com -->
    ...
    <ul class="niveau1">   
            ...
            <li><a href="GestionParametres/ParametresCompteBancaire.jsp"> <input type="button" class="btn btn-primary" value= " Paramètres Compte Bancaire " /> </a>  </li> 
    ...
    <div id="templatemo_content">
            ...
            <table>
	        <tr>
		        <td><input type="button" id="rechercherArticle"  class="btn btn-default"  value="  Liste des Banques  " size="35"/>  </td>
		        <td><input type="button" id="ajouterArticle"  class="btn btn-default"  value="  Ajouter Banque  " size="35"/>  </td>
	        </tr>
	        </table>	        
	        </form>		        
	    	...
	    	<div id ="dialogAjouterArticle"  title = "Ajouter Banque" >                    	            
           	<form id="formAjouterArticle" method="post"> 
           	<input type="hidden" name="montantCompte"  value="0.00">	                    
	        <table class="table ">         
			<tr>	
			    <td> Banque </td>
				<td><input type="text" name="banque"  size="60"/>  </td>				
			</tr>			
			</table>		             
	        </form>
           	</div> 
	        ...
	        <input type="hidden" name="idCompte"  id="idCompte" />					                    
	        <input type="hidden" name="banque"  id="banque" />	
	        <input type="hidden" name="montantCompte"  id="montantCompte"   />	    
	        </form>
