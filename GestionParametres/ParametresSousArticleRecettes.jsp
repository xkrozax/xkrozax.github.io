...
<!-- Free CSS Templates @ www.TemplateMo.com -->
    ...
    <ul class="niveau1">
            ...
            <li><a href="GestionParametres/ParametresSousArticleRecettes.jsp"> <input type="button" class="btn btn-primary" value= "  Gestion Sous-Article ou Produits du stock" /> </a>  </li>                                                        
    ...
    <div id="templatemo_content">
            ...
            <center>----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</center>	   
            <center>----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</center>	   
            <input type="button" id="affichierAjouterArticle"  class="btn btn-default"  value=" Nouveau Sous-Article ou Produit (+)" size="35"/>
	        ...
	        <tr>	
				...
				<% if ( (! tabArticle[i].getIdArticle().equals(1)) && (! tabArticle[i].getIdArticle().equals(3)) ){%>
			...
			<table align="left"  bordercolor="#000000" class="table " width="1400">  
			<tr> 	       
			    <td id="IDsousArticle"> Nom Produit / Sous Article </td>
			    ...
			    <td id="IDprixVente"> Prix Vente </td>
				<td id="IDprixVente2"><input type="number" name="prixVente"  class="number_input"/>  </td>					
			    <td id="IDstockInitial"> Quantité Stock Initial </td>
				<td id="IDstockInitial2"><input type="number" name="stockInitial"  class="number_input"/>  </td>					
