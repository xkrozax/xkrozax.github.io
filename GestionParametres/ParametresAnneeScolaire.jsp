<%@ page language="java" import="java.util.*" import="org.joda.time.LocalDate"  contentType="text/html; charset=UTF-8"%>
<%
...
<html>
  <head>
    ...
    LocalDate dateDeSysteme = new LocalDate(); 
    %>
    ...
    $("#chargement").show();  
        ...
        {    
            ...
            url: "rechercherAnneeScolaire.do", 
    ...
    $('#anneeScolarite2').change(function()  { 
        $("#chargement").show();  
        $.ajax( 
        {    
            type: "POST", 
...
<!-- Free CSS Templates @ www.TemplateMo.com -->
    ...
    <ul class="niveau1">   
            <li><a href="GestionParametres/ParametresAnneeScolaire.jsp"> <input type="button" class="btn btn-primary" value= " Paramètres Année Scolaire " /> </a>  </li>               	       
            ...
            <li><a href="GestionParametres/ParametresZoneTransport.jsp"> <input type="button" class="btn btn-default" value= " Paramètres Zone Transport " /> </a>  </li>               	                                            	                             
             <li><a href="GestionParametres/ParametresReductionScolarite.jsp"> <input type="button" class="btn btn-default" value= " Paramètres Réduction de scolarité " /> </a>  </li>     
    ...
    <div id="templatemo_content">
	        ...
	        <tr>
				...
				<td>  <select name="anneeScolarite"  id="anneeScolarite2" > 			 		
	            <% for(int i=yearSysteme;i>=2014;i--){%>
				<option  value="<%=i%>/<%=i+1%>"><%=i%>/<%=i+1%></option>
				<%} %>
		        </select>
		        </td>    
		        <td><input type="button" id="ajouterArticle"  class="btn btn-default"  value="  Ajouter Année Scolaire  " size="35"/>  </td>
	        </tr>
	        </table>	        
	        </form>		        
	    	...
	    	<div id ="dialogAjouterArticle"  title = "Ajouter Année Scolaire" >                    	            
           	<form id="formAjouterArticle" method="post">                     
	        <table class="table ">         
			<tr>	
			    <td> Année scolaire </td>
				<td>  <select name="anneeScolarite" > 			 		
	            <% for(int i=yearSysteme;i>=2014;i--){%>
				<option  value="<%=i%>/<%=i+1%>"><%=i%>/<%=i+1%></option>
				<%} %>
		        </select>
		    ...
		    <tr>  	
				...
				<td><input type="number" name="fraisScolarite" class="number_input4" size="60"/>  </td>				
			</tr>	
			<tr>  	
				<td> Frais d'inscription  </td>
				<td><input type="number" name="fraisInscription" class="number_input4" size="60"/>  </td>				
			</tr>	
			<tr>  	
				<td> Frais d'assurance  </td>
				<td><input type="number" name="fraisAssurance" class="number_input4" size="60"/>  </td>				
			</tr>			
			</table>		             
	        </form>
           	</div> 
	        ...
	        <input type="hidden" name="fraisScolarite"  id="fraisScolarite" />	
	        <input type="hidden" name="fraisInscription"  id="fraisInscription" />	
	        <input type="hidden" name="fraisAssurance"  id="fraisAssurance" />	  
	        </form>
