  ...
  <head>
    ...
    $("#chargement").show();  
        ...
        {    
            ...
            url: "rechercherZoneTransport.do", 
    ...
    $('#anneeScolaire2').change(function()  { 
        $("#chargement").show();  
        $.ajax( 
        {    
            type: "POST", 
...
<!-- Free CSS Templates @ www.TemplateMo.com -->
    ...
    <ul class="niveau1">   
            ...
            <li><a href="GestionParametres/ParametresZoneTransport.jsp"> <input type="button" class="btn btn-primary" value= " Paramètres Zone Transport " /> </a>  </li>               	                                            	                             
    ...
    <div id="templatemo_content">
	        ...
	        <tr> 
				...
				<td>  <select name="anneeScolaire"  id="anneeScolaire2" > 			 		
	            <% for(int i=yearSysteme;i>=2014;i--){%>
				<option  value="<%=i%>/<%=i+1%>"><%=i%>/<%=i+1%></option>
				<%} %>
		        </select>
		        </td>   
		        <td><input type="button" id="rechercherArticle"  class="btn btn-default"  value="  Liste Zone Transport  " size="35"/>  </td>
		        <td><input type="button" id="ajouterArticle"  class="btn btn-default"  value="  Ajouter Zone Transport  " size="35"/>  </td>
	        </tr>
	        </table>	        
	        </form>		        
	    	...
	    	<div id ="dialogAjouterArticle"  title = "Ajouter Zone Transport" >                    	            
           	<form id="formAjouterArticle" method="post">                  
	        <table class="table ">         
			<tr>
			    <td> Année scolaire </td>
				<td>  <select name="anneeScolaire" > 			 		
	            <% for(int i=yearSysteme;i>=2014;i--){%>
				<option  value="<%=i%>/<%=i+1%>"><%=i%>/<%=i+1%></option>
				<%} %>
		        </select>
		    ...
		    <tr>       	
			    <td> Zone Transport </td>
				<td><input type="text" name="zone"  size="20"/>  </td>
			</tr>
		    <tr>  	
				<td> Tarif </td>
				<td><input type="number" name="tarif" class="number_input4" size="20"/>  </td>				
			</tr>			
			</table>		             
	        </form>
           	</div> 
	        ...
	        <input type="hidden" name="idZoneTransport"  id="idZoneTransport" />					                    
