...
<html>
  <head>
	...
	if ((Integer) session.getAttribute("idFonctionnaire") != null){
      idUser = (Integer) session.getAttribute("idFonctionnaire");  
    } 
    role = "";
   ...
   $("form#formAjouterDocument").submit(function(){
    ...
    {         
        ...
        {    
            ...
            { 
               $("#chargement").hide();  
                window.location.replace("../../GestionMarches/Fichiers/ListeDesAchats.pdf");                        
            } 
         }); 
    });  
...
<!-- Free CSS Templates @ www.TemplateMo.com -->
	<div id="templatemo_header_panel">
    	...
    	<div id="site_title">
         ...
         <tr> 	
          ...
          <td><a href="GestionParametres/ParametresRecettes.jsp" > <input type="button" class="btn btn-primary" value= " Gestion du Stock et Articles" /> </a> </td>                
    ...
    <ul class="niveau1">
           ...
           <li> <a href="GestionDepense/Depenses.jsp"  > <input type="button" class="btn btn-primary" value= " Gestion Achats - Entrée de Stock" />  </a>   </li>
    ...
    <div id="templatemo_content">
	        ...
	        <input type="hidden" name="categorie" value="CaisseAssurance"/> 
	        ...
	        <tr>
		        ...
		        <td><input type="button" id="ajouterOperation"  class="btn btn-default"  value="  Nouvelle Opération d'Achat " size="35"/>  </td>
	      ...
	      <div id = "dialogAjouterOperationFinanciere" title = "Ajouter Opération d'Achat" >   	         	
	      ...
	      <input type="hidden" name="categorie" id="categorie" value="CaisseAssurance"/> 
	      ...
	      <table bgcolor=""  bordercolor="#000000" class="table " width="" >
		   ...
		   <tr> 	
				<td> Fournisseur  </td>
				<td> <input type="text" name="objet" id="objet" size="40"/> </td>			     
		   </tr>
		   <tr> 	
				<td> Remarque </td>
