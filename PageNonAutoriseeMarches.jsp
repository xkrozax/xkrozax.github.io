...
<!-- Free CSS Templates @ www.TemplateMo.com -->
	<div id="templatemo_header_panel">
		...
		<div id="site_title2">
         <a href="GestionMarchesPublics.jsp" > <input type="button" class="btn btn-default3" value= " Connexion " /> </a> 
	      <a href="Marches/LancementMarches/ListeMarches.jsp" > <input type="button" class="btn btn-primary" value= " Gestion des marches " />  </a>    
          <a href="GestionParametres/ParametresRecettes.jsp" > <input type="button"  class="btn btn-default3" value= " Gestion du Stock et Articles" /> </a>    
           <input type="button"  name="deConnecter" id="deConnecter" class="btn btn-danger" value="  Deconnecter 2 " size="35"/> 
        </div>
        <div id="header_links">
    ...
    <ul class="niveau1"> 
          ...
          <li><a href="GestionParametres/ParametresRecettes.jsp" > <input type="button" class="btn btn-default3" value= " Gestion du Stock et Articles" /> </a> </li>                     
