...
<html>
  ...
  <body>  
     ...
     <th> <font color="#000000"> Produit / SousArticle </font> </th>
     ...
     <th  width="90"> <font color="#000000"> Total Payé </font> </th>  
     </tr>
     <tr>
     ...
     <th  width="90"> <font color="#000000"> <h3>Montant d'Achat  </h3> </font> </th> 
     <th width="10">  </th>
     <th  width="90"> </th>
     </tr>   
     ...
     <%} else {%>  <td align="center"> <%=tabOperation[i].getQuantite()%> </td> <%} %>       
     <td align="center"> <%=tabOperation[i].getModePaiement()%> </td>                        
     <td align="center"> <%=tabOperation[i].getObjet()%> </td> 
     ...
     <td align="center" ><input type="button" id="supprimerOperation<%=i%>" class="btn btn-default4" value="X" /></td>
