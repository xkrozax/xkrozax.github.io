<%@ page language="java" import="java.util.*" import="metier.Membrecommssion"  import="metier.Fonctionnaire"  contentType="text/html; charset=UTF-8"%>
<%
...
<html>
  <head>
	...
	<%
	Membrecommssion[] tabMembrecommssion;
	tabMembrecommssion=(Membrecommssion[])request.getAttribute("listeMembresCommssion");
	 %>
	 <%
    ...
    { 
        ...
        {    
            ...
            url: "ajouterMembreCommission.do", 
    ...
    { 
        ...
        {    
            type: "POST", 
            enctype:"multipart/form-data",
            url: "modifierMembreCommission.do", 
            data:$("#formAjouterCommission").serialize(),
            dataType: "html", 
            //timeout : 4000, 
            error: function()
    ...
    {         
        ...
        $("#dialog5").dialog({
               ...
               Oui: function() {
                               ...
                               type: "POST", 
                               enctype:"multipart/form-data",
                               url: "supprimerMembreCommissionOP.do", 
                               data:$("#formAjouterCommission").serialize(),
                               dataType: "html", 
                              //timeout : 4000, 
                              error: function()
  ...
  <body>  
     ...
     <tr><td colspan="11"> <center>Aucun Membre de l'équipe du projet</center> </td></tr>  
     </table>
      <%} %>
     <%if(tabMembrecommssion.length>0){ %>
     <table   border="3" bgcolor=""   bordercolor="#000000" class="table table-hover "  width="800" >    
