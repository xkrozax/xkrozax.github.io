...
<html>
  ...
  <body>  
     ...
     <option  value="Réception provisoire partielle">Réception provisoire partielle</option>
     <option  value="Réception provisoire totale">Réception provisoire totale</option>
