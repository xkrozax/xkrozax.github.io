...
<html>
  <head>
    ...
    {         
        ...
        $("#ligneOrdreDeServiceC<%=i%>").addClass("table tr tr-selectionner"); 
    ...
    $('#afficherDocumentsOrdreDeService<%=i%>').click(function afficherDocumentsOrdreDeService() 
    {         
  ...
  <body>  
     ...
     <%if (modeOrdreDeService != 0) {	%>
     <th width="" > Phase </th>   
     <th width=""> Date de Commencement </th>
     ...
     <th width=""> Date Reçue par Entrepreneur </th>
     <%} %>
     <th> <input type="button"  id="ajouterOrdreDeService" class="btn btn-default4"  value=" + Ordre de service " size="35"/> <input type="button" id="ajouterModeOrdreDeService" class="btn btn-default4" value=" + phase" size="35"/>
	 ...
	 <%} %>
	                    ...
	                    <option  value="Ordre de service de commencement partiel">Ordre de service de commencement partiel</option>                                    
	 </select>
     </td>
     <%if (modeOrdreDeService != 0) {	%>
     ...
     <td align="center"> <input type="date" name="dateOrdreService2<%=i%>" id="dateOrdreService2<%=i%>"   value="<%=tabOrdreDeService[i].getDateOrdreService()%>" size="10"/></td>               
     ...
     <td align="center"><input type="button" class="btn btn-default4" id="afficherDocumentsOrdreDeService<%=i%>"  value="Pièces jointes" size="35"/></td>     
     <%} %>
     </tr>
     <%} %>
     </table>
