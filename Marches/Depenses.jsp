	...
	$(function(){
     ...
     $.ajax( 
        {    
            ...
            { 
               $("#chargement").hide(); 
               $("#idFournisseur1").html(html); 
               $("#idFournisseur2").html(html);                     
            } 
         }); 
   ...
   $('#idSousArticle2').change(function()  {    
    ...
    {         
        ...
        {    
            ...
            { 
               $("#chargement").hide();  
               window.location.replace("../../GestionEntrepriseBTP/Fichiers/ListeDesDesenses.pdf");                         
            } 
         }); 
    });  
...
<!-- Free CSS Templates @ www.TemplateMo.com -->
    ...
    <ul class="niveau1">
            ...
            <li><a href="Marches/Depenses.jsp"  > <input type="button" class="btn btn-primary" value= " Dépenses " /> </a> </li> 
    ...
    <div id="templatemo_content">
			...
			<tr>
				...
				<td> Produit / Sous Article </td>
				<td><select name="idSousArticle" id="idSousArticle"  >
				     <option  value="0"></option>		
				    </select>
				</td>
				<td> Fournissuer </td>
                <td><select name="idFournisseur" id="idFournisseur1"  >
				     <option  value="0"></option>		
				    </select>
				</td>		
			    <td> Année </td>
	        ...
	        <tr>
		        ...
		        <td><input type="button" id="ajouterOperation"  class="btn btn-default"  value="  Nouvelle Opération Dépense " size="35"/>  </td>
	      ...
	      <div id = "dialogAjouterOperationFinanciere" title = "Ajouter Opération Dépense" >   	         	
	      ...
	      <table bgcolor=""  bordercolor="#000000" class="table " width="" >
           ...
           <tr>
                <td> Fournissuer </td>
                <td><select name="idFournisseur" id="idFournisseur2"  >
				     <option  value="0"></option>		
				    </select>
				</td>
           </tr>
           <tr> 	
				<td>  </td>
				<td> <input type="hidden" name="objet" id="objet" size="50"/> </td>			     
		   </tr>  
		   <tr> 	
				<td> Remarque </td>
