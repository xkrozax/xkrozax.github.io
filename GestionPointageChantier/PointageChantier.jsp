  ...
  <head>
    ...
    {         
        ...
        {    
            ...
            { 
               $("#chargement").hide();  
               window.location.replace("../../Madrassati/Fichiers/JournalDePaie.pdf");                         
            } 
         }); 
    });
       
     $('#exporterDeclarationCNSS').click(function exporterDeclarationCNSS() 
    {         
        $("#chargement").show();
        $.ajax( 
        {    
            type: "POST", 
            enctype:"multipart/form-data",
            url: "exporterDeclarationCNSS.do", 
            data:$("#formRechercherBulletinPaie").serialize(),
            dataType: "html", 
            //timeout : 4000, 
            error: function()
            ...
            { 
               $("#chargement").hide();  
               window.location.replace("../../Madrassati/Fichiers/DeclarationCNSS.pdf");                         
            } 
         }); 
    });   
     $('#exporterDeclarationAMO').click(function exporterDeclarationAMO() 
    {         
        $("#chargement").show();
        $.ajax( 
        {    
            ...
            { 
               $("#chargement").hide();  
               window.location.replace("../../Madrassati/Fichiers/DeclarationAMO.pdf");                         
            } 
         }); 
    });   
    
    $('#exporterDeclarationIR').click(function exporterDeclarationIR() 
    {         
        $("#chargement").show();
        $.ajax( 
        {    
            ...
            { 
               $("#chargement").hide();  
               window.location.replace("../../Madrassati/Fichiers/DeclarationIR.pdf");                         
            } 
         }); 
    });     
...
<!-- Free CSS Templates @ www.TemplateMo.com -->
    ...
    <ul class="niveau1">            
            ...
            <li><a href="GestionPointageChantier/PointageChantier.jsp"  > <input type="button" class="btn btn-primary" value= " Pointage chantier " />  </a> </li> 
    ...
    <div id="templatemo_content">
         ...
         <form id="formRechercherBulletinPaie" method="post">  
            ...
            <input type="hidden" name="salaireParHeure" id="salaireParHeure"/> 
            <input type="hidden" name="salaireParJour" id="salaireParJour"/>        
            ...
            <input type="hidden" name="jour1" id="jour1"/>
            <input type="hidden" name="jour2" id="jour2"/>
            <input type="hidden" name="jour3" id="jour3"/>
            <input type="hidden" name="jour4" id="jour4"/>
            <input type="hidden" name="jour5" id="jour5"/>
            <input type="hidden" name="jour6" id="jour6"/>
            <input type="hidden" name="jour7" id="jour7"/>
            <input type="hidden" name="jour8" id="jour8"/>
            <input type="hidden" name="jour9" id="jour9"/>
            <input type="hidden" name="jour10" id="jour10"/>
            <input type="hidden" name="jour11" id="jour11"/>
